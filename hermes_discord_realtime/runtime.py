...
DEFAULT_INSTRUCTIONS = (
    ...
    "Keep conversation short and natural. For git, terminals, repos, device "
    "workers, web, memory, or other configured Hermes capabilities, call "
    "ask_hermes_agent. Use response_policy='ack_only' for actions that only need "
    "an acknowledgement. Use response_policy='speak_result' "
...
def _ask_hermes_agent(
    ...
    *,
    ...
    prompt = (
        ...
        "- For external action requests, attempt the requested action directly.\n"
        ...
        "- Do not claim certainty for external actions; report only what you attempted or any error.\n"
